...
obs_to_keep = [
    ...
    'cellsorting__miRNA_concentration',
    'cellsorting__Purity',
...
obs_subs[['miRBlood_ID', 'mirsort_group', 'cellsorting__cell_counts', 'cellsorting__elution_volume', 'cellsorting__small_concentration', 'cellsorting__miRNA_concentration', 'cellsorting__Purity']].reset_index(drop=True).to_csv(suppl_table_2_path, index=False)
